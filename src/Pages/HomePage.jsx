...
import Nature from "../assets/photo15.jpeg";
import Room from "../assets/room14.jpeg";
...
import Slider from "../assets/photo16.jpeg";
import Slider3 from "../assets/photo17.jpeg";
      ...
      <section className="py-12 px-4 md:px-12 bg-gray-100">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 mt-2">
            Discover travel tips, local attractions, and guest stories from Samar Niwas.Affordable hotels in Dehradun
          </p>
        </div>
